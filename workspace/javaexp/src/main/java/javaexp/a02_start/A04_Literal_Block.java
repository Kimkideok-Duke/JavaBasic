...
public class A04_Literal_Block {
	...
	public static void main(String[] args) {
		...
		/*
		 # 중괄호 블럭의 사용
		 1. 모든 코드는 {}(중괄호)단위로 계츨적으로 사용하고 있다.
		 2. 최상위 단위인 클래스선언으로 부터 매서드, 조건문 반복문, 기능 블럭등에 이 내용이 사용되는데, 계층적으로 효율적으로 선언하여, 해당 블럭내에 명령문들이 사용된다.
		 ...
		 4. 중괄호 블럭을 효율적으로 처리하기 위한 방법
		 	...
		 	2) 코드가 많아져 이런 에러가 발생시, 해당 범위내에 있는 모든 내용을 주석문으로 설정하고, 하나씩 단계별로 주석문을 풀어가면서 빠진부분을 확인한다.
		 */
